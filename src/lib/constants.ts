...
export const pricingCards = [
  ...
  },
  {
    ...
    description: 'Build your agency and start selling.',
    price: '$99',
    duration: 'month',
    highlight: 'Key features',
    features: ['Rebilling', '24/7 Support team'],
    priceId: 'price_1PB22sKbfpOCBOoYpekWuNt2',
  },
  {
    title: 'Basic',
    ...
    priceId: 'price_1PB22LKbfpOCBOoY4dYxokvn',
  },
]

export const addOnProducts = [
  { title: 'Priority Support', id: 'prod_Q0uMTPtlIZyqPM' },
]
